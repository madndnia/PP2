...
#misic
pygame.mixer.music.load("lab 8_background.wav")
...
dollar_im = pygame.image.load(r"C:\Users\Madina\Desktop\python1\Lab9\dollar.png")
...
while running: 
    ...
    if pygame.sprite.spritecollideany(P1, enemies):
          pygame.mixer.Sound('lab 8_crash.wav').play()
          time.sleep(0.5)
